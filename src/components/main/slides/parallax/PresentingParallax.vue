<template>
  <div
    id="presenting"
    ref="target"
    class="relative left-[-6vw] pl-[3vw] perspective-near h-screen landscape:max-w-screen overflow-hidden no-scrollbar shrink-0 flex justify-between items-center"
  >
    <div
